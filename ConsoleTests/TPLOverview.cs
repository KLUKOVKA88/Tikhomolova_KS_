...
namespace ConsoleTests
{
    class TPLOverview
    {
        public static void Start()
        {
            ...
            var result = result_task.Result; //не рекомендуется к использованию из-за вероятности мертвой блокировки
            ...
            Task.WaitAll(result_task, result_task2, result_task3); // костыли! не рекомендуется к использованию из-за вероятности мертвой блокировки
            Task.WaitAny(result_task, result_task2, result_task3); // костыли! не рекомендуется к использованию из-за вероятности мертвой блокировки
